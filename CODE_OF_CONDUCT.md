...
any other project-related space), and also applies when an individual is officially representing the
...
maintainers. For sensitive reports, use GitHub's [private vulnerability reporting][advisories]
feature on this repository (Security tab) even for non-security conduct issues — it reaches the
maintainers privately, which is the point. All complaints will be reviewed and investigated promptly
and fairly.
...
well as external channels. Violating these terms may lead to a temporary or permanent ban.
